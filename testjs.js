...
for(var i = 0; i < dataJSON.Personal.length; i++) {
    ...
    dataJSON.Personal[i].Förnamn + " " + dataJSON.Personal[i].Efternamn+"</button><p class='moro' style='display:none'>Hit infon</p></p>";   //Loopar igenom alla förnamn och efternamn och
